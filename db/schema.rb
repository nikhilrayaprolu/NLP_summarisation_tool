...
ActiveRecord::Schema.define(version: 2020_02_01_172524) do
  ...
  create_table "picco_blog_posts", force: :cascade do |t|
    t.string "title"
    t.text "text"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    ...
    t.string "featured_image_name"
    t.index ["author_id"], name: "index_picco_blog_posts_on_author_id"
    t.index ["members_only"], name: "index_picco_blog_posts_on_members_only"
    t.index ["slug"], name: "index_picco_blog_posts_on_slug"
    t.index ["state"], name: "index_picco_blog_posts_on_state"
  end
  ...
  create_table "post_summaries", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["post_id"], name: "index_post_summaries_on_post_id"
  end

  create_table "posthistory", id: false, force: :cascade do |t|
    t.integer "Id"
    t.integer "PostHistoryTypeId"
    t.integer "PostId"
    t.text "RevisionGUID"
    t.datetime "CreationDate"
    t.integer "UserId"
  ...
  create_table "postlinks", id: false, force: :cascade do |t|
    t.integer "Id"
    t.datetime "CreationDate"
    t.integer "PostId"
    t.integer "RelatedPostId"
    t.integer "PostLinkTypeId"
  ...
  create_table "posts", primary_key: "Id", force: :cascade do |t|
    ...
    t.integer "ParentId"
    t.integer "AcceptedAnswerId"
    t.datetime "CreationDate"
    t.integer "Score"
    t.integer "ViewCount"
    t.text "Body"
    t.integer "OwnerUserId"
    t.text "OwnerDisplayName"
    t.integer "LastEditorUserId"
    t.text "LastEditorDisplayName"
    t.datetime "LastEditDate"
    t.datetime "LastActivityDate"
    t.datetime "CommunityOwnedDate"
    t.text "Title"
    t.text "Tags"
